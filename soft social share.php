<?php
/*
  Plugin Name: Soft Social Share
  plugin URI: https://www.github.com/tiseysoft
  Description: Simple Social Share Plugin That Displays Social Share Icons Below Every Post
  version: 1.0.0
  Author: Tisey Soft
 */

 function social_share_menu_item(){
    add_submenu_page("options-general.php", "Soft Social Share", "Soft Social Share", "manage_options", "social-share", "social_share_page");
 }

 //adding action
 add_action("admin_menu", "social_share_menu_item");

 //creating the page. when the menu item is clicked
 function social_share_page(){
     ?>
     <div class="wrap">
     <h1> Soft Social Share </h1>
 ...
 //adding the check boxes in the options page
...
//proccessing the share buttons to actually share stuff
...
//adding style to the entire thing. including buttons
